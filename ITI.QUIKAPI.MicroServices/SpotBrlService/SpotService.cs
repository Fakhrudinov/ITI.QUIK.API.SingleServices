...
namespace SpotBrlService
{
    public class SpotService : ISpotBrlService
    {
        ...
        public SpotService(IOptions<QadminLogon> logon)
        {
            _logon = logon.Value;
        }
        ...
        private async Task<string> CheckConnectionQadmin()
        {
            ...
            try
            {
                ...
                int errCode = NativeMethods.QDAPI_Connect(@"QDealerAPI.ini", _logon.Login, _logon.Password, ref conErrPtr);
        ...
        private Task<string> CloseQuikQadminAPI(string Firm)
        {
            ...
            {
                Console.WriteLine("CheckConnectionQadmin Error " + ex.Message);
                return Task.FromResult($"CheckConnectionQadmin Error {ex.Message}");
            }
        }
